...
Use case: RStudio with git installed on the computer

Completely web-based alternatives discussed!
:::
...
Pull some examples from big ideas?


Majority of these students work with data

We have a responsibility to help create literate, critical, ethical thinkers in this world of big data


How: Immerse students in modern data practices

Immerse students (and faculty) in collaboration and reproducibility

Demonstrate reproducibility
Journals are requiring preregistration, data for submissions, and code to be available in order to reproduce studies. 
Public library of science 
Natural science 
Most International Committee of Medical Journal Editors
etc
...
## Outline Reproducibility Ideas


## Discuss Common Technologies & Basic usage
...
```{r, echo = FALSE, fig.align='center', out.width = "350px"}
knitr::include_graphics("img/bad_good.jpg")
```
